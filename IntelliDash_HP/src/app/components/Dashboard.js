...
const renderChart = (visualization, theme) => {
    ...
    switch (chart.type) {
        case 'line':
            return <LinePlot commonProps={commonProps} chart={chart} theme={theme} />
        case 'bar':
            return <BarPlot commonProps={commonProps} chart={chart} theme={theme} />
        case 'scatter':
            return <ScatterPlot commonProps={commonProps} chart={chart} chartData={chartData} theme={theme} />
        default:
            return null
    }
}